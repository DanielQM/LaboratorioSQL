...
/* Ver tablas de bases de datos en uso */
...
/* Visualizar solo los departamentos que perteneces al grupo Marketing y Ventas */
SELECT *
FROM HumanResources.Department
WHERE HumanResources.Department.GroupName = 'Sales and Marketing'
GO

/* Ver listado de todos los empleados cuyo estado civil es casado*/
SELECT HumanResources.Employee.BusinessEntityID AS 'Código de Empleado', HumanResources.Employee.MaritalStatus AS 'Estado Civil'
FROM HumanResources.Employee
WHERE HumanResources.Employee.MaritalStatus like 'M'
GO

/* Ver listado DEL código de las órdenes de ventas  y su respectivo mes del año 2013 */
SELECT Sales.SalesOrderHeader.SalesOrderID AS 'Código de Orden',DATENAME(MONTH, Sales.SalesOrderHeader.OrderDate) AS 'Mes',YEAR(Sales.SalesOrderHeader.OrderDate) AS 'Año'
...
SELECT COUNT(HumanResources.Employee.BusinessEntityID) AS 'Total', HumanResources.Employee.JobTitle AS 'Cargo'
FROM HumanResources.Employee
...
/* Mostrar el nombre, apellido, departamento, estado civil del empleado */
SELECT 
HumanResources.Department.Name AS Departamento,
